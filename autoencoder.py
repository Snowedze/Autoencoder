...
n_samples = 1000 #number of images on dataset

import importer_  #importer_ import the data and treatment d the data
num_pix = importer_.jj # number of values per array (total numer of pixels on one image ex: 28x28 = '784') on my case: 3025
data1 = importer_.read_data_sets_treino(n_samples)   #treatment of the data, making a matrix of one image per line
#data1 = old mnist, matrix of one image per line
...
class VariationalAutoencoder(object):
    def __init__(self, network_architecture, transfer_fct=tf.nn.softplus,
                 learning_rate=0.001, batch_size=100):  #learning_rate = 0,001 
...
def plot_line(num_line):
    ...
    #plt.ylabel("")
    plt.show()
print('to plot a line use: plot_line("line")')
#plot_line(2)
